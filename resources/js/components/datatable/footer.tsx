...
export default function TableFooter<TData, TValue>({ table, data, perPage, handleChangePerPage }: TableFooterProps<TData, TValue>) {
   return (
      <>
         {data.meta && (
            <Fragment>
                  ...
                  <div className="left-section flex-1 flex items-center gap-2">
                     ...
                     <div className="hidden md:flex text-sm font-medium text-slate-800 items-center gap-1">
                        <span className={'text-sm font-semibold'}>
                           {table.getState().pagination.pageIndex == 0 ? 1 : table.getState().pagination.pageIndex}
                        </span>
                        dari

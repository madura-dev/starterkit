import { flexRender, getCoreRowModel, RowData, useReactTable, VisibilityState } from '@tanstack/react-table';
   ...
   return (
      <Fragment>
         ...
         <div className="table-wrapper overflow-hidden rounded-md border-slate-200 border">
                  ...
                  {table.getRowModel().rows.length > 0 ? (
                     ...
                     <TableRow className={'bg-white hover:bg-white'}>
                        <TableCell colSpan={columns.length} className={'text-center py-8'}>
                           <img src={NoDataIllustration} className={'h-96 mx-auto'} alt={'No Data'} />
                           <h4 className={'text-3xl font-semibold text-primary/80 mt-5'}>Data tidak ditemukan</h4>
                           <p className="text-base">
                              Silahkan anda tambahkan terlebih dahulu, kemudiah refresh halaman ini kembali.
                           </p>
                        </TableCell>
                     </TableRow>
                  )}
            ...
            <div className={'py-6 px-4 flex w-full items-center bg-slate-100/20 border-t'}>
               <TableFooter
                  data={data}
                  table={table}
                  perPage={'10'}

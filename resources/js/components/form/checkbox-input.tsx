...
const CheckboxInput = forwardRef<InputHTMLAttributes<HTMLInputElement>, CheckboxInputProps>(function CheckboxInput(props, ref) {
   const { name, label, errors } = props;
   return (
      <Fragment>
         <div className="items-top flex space-x-2">
            <Checkbox id={name} onCheckedChange={props.onCheckedChange} name={name} />

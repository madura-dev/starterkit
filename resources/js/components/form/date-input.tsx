...
const DateInput = forwardRef<HTMLInputElement, DateInputProps>(function DateInput(props, ref) {
      ...
      <div className={'grid w-full gap-1.5'}>
         <Popover open={open} onOpenChange={setOpen}>
            <PopoverTrigger asChild>
               ...
               >
                  {date ? format(date, 'dd, LLLL yyyy', { locale: id }) : <span>{date || props.placeholder}</span>}

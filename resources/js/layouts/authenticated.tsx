...
import { IconBell, IconRotate3d } from "@tabler/icons-react";
                ...
                <div className="flex h-full max-h-screen border-r-2 border-slate-200/30 flex-col gap-2">
                    <div className="flex h-14 items-center px-4 lg:h-[60px] lg:px-6">
                        <Link href="/" className="flex items-center gap-2 font-semibold">
                            ...
                            <h1 className="">Linertya<span className={'font-bold text-4xl text-teal-700'}>.</span> </h1>
                        </Link>
                    ...
                    <SimpleBar forceVisible="y" style={{ maxHeight : '70vh' }} className="flex-1">
                        <Sidebar/>
                    </SimpleBar>
